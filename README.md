...
このアプリを作る目的を3つに設定しました。
 ...
 -現代版サッカー日誌として選手に活用してもらう
 -自分の現状の技術レベルを把握して、次の練習の課題を見つける
 -プレーを言語化しつづけることで、試合中に的確な判断をできるようにする
 
### 「現代版サッカー日誌としてサッカー選手に活用してもらう」
...
### 2利用方法
 1.サイドバーの「マイページ」をクリックしマイページに遷移
 2.「編集」をクリックして編集ページに遷移
 3.情報を変更し、「編集」をクリックすると編集完了
...
### 3利用方法
 1.「写真のアイコン」をクリックすると投稿ページへ遷移
 2.情報を入力し、「投稿」をクリックすると投稿完了
...
### 4利用方法
 1.サイドバーの「ユーザー一覧」をクリックし、ユーザー一覧画面に遷移
 2.ユーザーのニックネームをクリックするとユーザー詳細画面に遷移
 3.「家のアイコン」をクリックし、トップページに遷移
...
### 5利用方法
 1.投稿してある「タイトル名」をクリックし、投稿詳細ページに遷移
 2.ログインしている場合のみコメントを入力して「送信」してコメント完了
...
### 6利用方法
 1.サイトバーのジャンル検索の下にあるボックスでジャンル指定
 2.ジャンル指定した後に「検索」をクリックすると検索ページに遷移
