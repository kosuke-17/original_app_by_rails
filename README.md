...
一つ一つの自分のプレーを振り返ることで、足りない基礎の技術や意図するプレーを文字に起こすことで客観的に自分のレベルを可視化することができます。
...
「認知→理解→計画→動作→認知→・・・」のように一瞬で論理的思考能力を働かせて判断しています。
...
サッカー選手としてだけでなく、人間力の向上を見込めます。

# 洗い出した要件
 - 考えを言語化してアウトプット(投稿機能) 
 - 他者の考えや視点を学ぶ(ユーザー管理機能・検索機能) 
 - 言語化した考えを記録(投稿・編集機能)
 - 考えを共有(コメント機能)
